...
public class employee_gui {
    ...
    public void employee_() {
        ...
        String data = eObj.wholeData;

        String[] c = eObj.columnsName;
        int count_r = eObj.count_DataRow;
        ...
        mainLabel = new JLabel("Current  Employees  record");
        ...
        data_entry_container.setLayout(new GridLayout(6, 2, 10, 20));
        ...
        String shift[] = {"Pilot", "Guade", "Air Hostess"};
        FlightClass = new JComboBox(shift);
        e = new JLabel();
        e2 = new JLabel();
        salaryL = new JLabel();
        ...
        salaryL = new JLabel("Salarly");
        salaryT = new JTextField();

        data_entry_container.add(salaryL);
        data_entry_container.add(salaryT);
        ...
        add.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                try {
                    ...
                    salarly = Integer.parseInt(salaryT.getText());

                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(null, "Enter an integer value in Salarly");
                    return;
                }

                Object[] newRow = {name, id, salarly, gender, FlightClass.getSelectedItem()};
                model.addRow(newRow);

                // File append
                try {
        
                    FileWriter fw = new FileWriter("Efile.txt", true);
                    PrintWriter pw = new PrintWriter(fw);

                    String s1 = name + "/" + id + "/" + salarly + "/" + gender + "/" + FlightClass.getSelectedItem();
